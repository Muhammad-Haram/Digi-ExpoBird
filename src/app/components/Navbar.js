...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <nav className="py-6 w-full flex items-center justify-between md:space-x-5">
            ...
            <div className="flex items-center">
              <ul className="flex items-center gap-[40px] xl:space-x-10 list-none space-x-3 cursor-pointer">
                ...
                <li
                  className="md:text-[14px] text-white text-[16px] font-semibold"
      ...
      <div
        className={`z-50 sm:hidden fixed cursor-pointer top-0 left-0 h-screen w-full bg-[#000213] text-white transform transition-transform duration-300 ${
          isMobileMenuOpen
            ? "translate-y-0 sm:hidden md:hidden"
            : "translate-y-full sm:hidden md:hidden"
        }`}
      >
        <button
          onClick={toggleMobileMenu}
