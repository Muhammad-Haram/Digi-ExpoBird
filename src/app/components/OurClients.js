        ...
        <article className="sm:h-[350px] h-[450px] wrapper sm:py-1 sm:pb-0 pb-5">
          <div className="marquee">
            <div className="marquee__group gap-[8px]">
              <Image src={"/assets/client01.webp"} height={150} width={200} alt="pic" />
              <Image src={"/assets/client02.webp"} height={150} width={200} alt="pic" />
              <Image src={"/assets/client03.webp"} height={150} width={200} alt="pic" />
              <Image src={"/assets/client04.webp"} height={150} width={200} alt="pic" />
              <Image src={"/assets/client05.webp"} height={150} width={200} alt="pic" />
            </div>
